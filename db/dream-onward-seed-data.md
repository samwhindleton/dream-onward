...
('John', 'Smith', 'john.smith@noemail.com', 'LastSamurai', 'LastSamurai'),
('Mary', 'Jones', 'mary.jones@noemail.com', 'PetalPrincess', 'PetalPrincess'),
('Oliver', 'Williams', 'oliver.williams@noemail.com', 'CapnBloodBeard', 'CapnBloodBeard'),
('Elizabeth', 'Taylor', 'elizabeth.taylor@noemail.com', 'FallenAngel', 'FallenAngel'),
('William', 'Brown', 'william.brown@noemail.com', 'SavageHorseman', 'SavageHorseman'),
('Olivia', 'Davies', 'olivia.davies@noemail.com', 'IMTooPrettyToDie', 'IMTooPrettyToDie'),
('Jack', 'Evans', 'jack.evans@noemail.com', 'LoneWalker', 'LoneWalker'),
('Sarah', 'Thomas', 'sarah.thomas@noemail.com', 'CatWoman', 'CatWoman'),
('Thomas', 'Johnson', 'thomas.johnson@noemail.com', 'BeoWulf', 'BeoWulf'),
('Isla', 'Wilson', 'isla.wilson@noemail.com', 'SniperFemme', 'SniperFemme'),
('Harry', 'Roberts', 'harry.roberts@noemail.com', 'DexterzProtege', 'DexterzProtege'),
('Margaret', 'Robinson', 'margaret.robinson@noemail.com', 'CursedWings', 'CursedWings'),
('George', 'Wright', 'george.wright@noemail.com', 'NoTolerance', 'NoTolerance'),
('Emily', 'Thompson', 'emily.thompson@noemail.com', 'IceQueen', 'IceQueen'),
('Jacob', 'White', 'jacob.white@noemail.com', 'DarkLord', 'DarkLord'),
('Ann', 'Hall', 'ann.hall@noemail.com', 'SongbirdFatale', 'SongbirdFatale'),
('James', 'Walker', 'james.walker@noemail.com', 'InfernalHeir', 'InfernalHeir'),
('Jane', 'Green', 'jane.green@noemail.com', 'LadyPhantom', 'LadyPhantom'),
('Robert', 'Edwards', 'robert.edwards@noemail.com', 'RuthlessSlayer', 'RuthlessSlayer'),
('Ava', 'Woods', 'ava.woods@noemail.com', 'WarriorPriestess', 'WarriorPriestess'),
('Charles', 'Hughes', 'charles.hughes@noemail.com', 'JackSparrow', 'JackSparrow'),
('Alice', 'Jackson', 'alice.jackson@noemail.com', 'Hraefn', 'Hraefn'),
('George', 'Turner', 'george.turner@noemail.com', 'Kladenstien', 'Kladenstien'),
('Isabella', 'Lewis', 'isabella.lewis@noemail.com', 'Zeldarian', 'Zeldarian');
```
